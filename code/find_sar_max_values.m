clear all; close all;
%% =========================================================================
% SCRIPT FOR DISPLAYING XZ SLICE - SAR DISTRIBUTION (with auto max detection)
% =========================================================================
...
cb = colorbar;
cb.Label.String = 'Normalized SAR [dB]';
cb.Label.FontWeight = 'bold';

xlabel('X axis (mm)', 'FontWeight', 'bold');
ylabel('Z axis (mm)', 'FontWeight', 'bold');
yline(5, 'w--', 'LineWidth', 1.5);
title(sprintf('SAR Distribution - XZ slice (Y = %.4f mm)', y_plot_mm(y_index)), ...
    'FontWeight', 'bold');
